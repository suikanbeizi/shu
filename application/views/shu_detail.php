...
<div class="deltail">
	...
	<div class="deltailjs">
		...
		<div class="jsright">
			...
			<p><span>价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格：</span><i>￥<?php echo $details->book_price ?></i></p>
			...
			<div class="gm">
				...
				<p><a href="javascript:void(0);" class="goumai" ><span class="glyphicon glyphicon-hand-up"></span>立即购买</a><a href="<?php echo site_url('index.php/shu_user/gouwuche/'.$details->book_id)?>"><span class="glyphicon glyphicon-shopping-cart"></span>加入购物车</a></p>
			</div>
		</div>
	</div>
