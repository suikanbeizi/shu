                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-border-form tpl-form-border-br" method="POST" action="<?php echo site_url('index.php/shu_user/admin_xiugai_book/'.$books->book_id)?>">
                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">书籍名称<span class="tpl-form-line-small-title">Name</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" placeholder="请输入书籍名称" name="book_name" value="<?php echo $books->book_name ?>">
                                            <small>请填写书籍全称</small>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" placeholder="请输入作者" name="book_anthor" value="<?php echo $books->book_anthor ?>">
                                            <small>请填写作者全称</small>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" placeholder="请输入出版社" name="book_chubanshe" value="<?php echo $books->book_chubanshe ?>">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="am-form-field tpl-form-no-bg" placeholder="发布时间" data-am-datepicker="" readonly="" name="book_time" value="<?php echo $books->book_time ?>">
                                            <small>发布时间为必填</small>
                                        </div>
                                    </div>
                                     <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" placeholder="请输入书籍字数" name="book_zs" value="<?php echo $books->book_zs ?>">
                                            <small>请填写数字</small>
                                        </div>
                                    </div>
                                     <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" placeholder="请输入价格" name="book_price" value="<?php echo $books->book_price ?>">
                                            <small>请填写数字</small>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" placeholder="输入出售数量" name="book_num" value="<?php echo $books->book_num ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <div class="am-form-group am-form-file">
                                                ...
                                                <input id="doc-form-file" type="file" multiple="" name="book_img">
                                            </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <textarea class="" rows="10" id="user-intro" placeholder="请输入书籍内容描述" name="book_des" value="<?php echo $books->book_des ?>"></textarea>
                                        </div>
                                    </div>
